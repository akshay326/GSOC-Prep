...
*/
public interface ViSPEngineInterface extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements org.visp.engine.ViSPEngineInterface
{
private static final java.lang.String DESCRIPTOR = "org.visp.engine.ViSPEngineInterface";
...
/**
 * Cast an IBinder object into an org.visp.engine.ViSPEngineInterface interface,
 * generating a proxy if needed.
 */
public static org.visp.engine.ViSPEngineInterface asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof org.visp.engine.ViSPEngineInterface))) {
return ((org.visp.engine.ViSPEngineInterface)iin);
}
return new org.visp.engine.ViSPEngineInterface.Stub.Proxy(obj);
}
...
private static class Proxy implements org.visp.engine.ViSPEngineInterface
{
