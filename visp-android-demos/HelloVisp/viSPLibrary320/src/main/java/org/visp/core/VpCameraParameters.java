...
public class VpCameraParameters {
    ...
    public VpCameraParameters(long addr) { nativeObj = addr; }
    ...
    //javadoc: VpCameraParameters::VpCameraParameters(c)

    public   VpCameraParameters(VpCameraParameters c)
    {
        
        nativeObj = VpCameraParameters_2(c.nativeObj);
    ...
    public   VpCameraParameters()
    {
        ...
        nativeObj = VpCameraParameters_3();
    ...
    //javadoc: VpCameraParameters::getFovNormals()

    public  List<VpColVector> getFovNormals()
    {
        
        long[] addressList = getFovNormals_0(nativeObj);
        List<VpColVector> retVal = Converters.Array_to_vector_vpColVector(addressList);
        return retVal;
    }
    ...
    //javadoc: VpCameraParameters::init(c)

    public  void init(VpCameraParameters c)
    {
        
        init_0(nativeObj, c.nativeObj);
    ...
    // C++:   vpCameraParameters(vpCameraParameters c)
    private static native long VpCameraParameters_2(long c_nativeObj);

    // C++:   vpCameraParameters()
    private static native long VpCameraParameters_3();
    ...
    // C++:  vector_vpColVector getFovNormals()
    private static native long[] getFovNormals_0(long nativeObj);

    // C++:  void computeFov(int w, int h)
    private static native void computeFov_0(long nativeObj, int w, int h);

    // C++:  void init(vpCameraParameters c)
    private static native void init_0(long nativeObj, long c_nativeObj);
